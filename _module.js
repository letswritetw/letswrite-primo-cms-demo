...
function create_fragment$3(ctx) {
	...
	return {
		...
		h() {
			attr(div0, "class", "section-container content svelte-1sp8qf2");
			attr(div1, "class", "section");
			attr(div2, "class", "section");
			attr(div2, "id", "section-f3378cd4");
		},
		m(target, anchor) {
			insert_hydration(target, div2, anchor);
...
function create_each_block_1$1(ctx) {
	...
	return {
		...
		h() {
			attr(a, "class", "link svelte-1x1lvs1");
...
function create_fragment$4(ctx) {
	...
	return {
		...
		l(nodes) {
			...
			var a_nodes = children(a);
			t1 = claim_text(a_nodes, "Let's Write");
			a_nodes.forEach(detach);
		...
		h() {
			attr(nav_1, "class", "svelte-1x1lvs1");
			attr(a, "href", "https://www.letswrite.tw");
			attr(a, "class", "svelte-1x1lvs1");
			attr(span, "class", "primo svelte-1x1lvs1");
			attr(div0, "class", "social-links svelte-1x1lvs1");
			attr(footer, "class", "section-container svelte-1x1lvs1");
			attr(div1, "class", "section");
			attr(div1, "id", "section-3150090d");
		},
		m(target, anchor) {
	...
	component_1 = new Component$2({
			props: {
				logo: {
					"image": {
						"alt": "Let's Write",
						"src": "https://letswritetw.github.io/letswritetw/dist/img/logo_512.png",
						"url": "https://letswritetw.github.io/letswritetw/dist/img/logo_512.png",
						"size": null
					},
					"title": "Let's Write Primo Demo"
				},
				site_nav: [
					{
						"link": {
							"url": "https://www.letswrite.tw",
							"label": "Home",
							"active": false
						}
					},
					{
						"link": {
							"url": "https://www.letswrite.tw/sitemap/",
							"label": "所有筆記文"
						}
					},
					{
						"link": {
							"url": "https://t.me/+Hj2RZZeT65liYTM1",
							"label": "Let's News"
						}
					}
				]
			...
			props: {
				...
				social: [
					...
					},
					{
						"icon": "mdi:github",
						"link": {
							"url": "https://github.com/letswritetw",
							"label": "GitHub"
						}
					}
				]
